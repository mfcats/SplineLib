...
class ParameterSpace {
 public:
  ...
  ParameterSpace(const std::shared_ptr<std::array<baf::KnotVector, DIM>> &knot_vector, std::array<int, DIM> degree) : degree_(degree),
                                                                                                     knot_vector_(
                                                                                                         knot_vector) {
 ...
 private:
  std::shared_ptr<std::array<baf::KnotVector, DIM>> knot_vector_;
