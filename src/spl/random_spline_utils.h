...
std::array<Degree, PARAMETRIC_DIMENSIONALITY> GetRandomDegrees(int max_degree) {
...
template<int PARAMETRIC_DIMENSIONALITY>
std::array<int, PARAMETRIC_DIMENSIONALITY> GetNumberOfKnots(
...
template<int PARAMETRIC_DIMENSIONALITY>
baf::KnotVectors<PARAMETRIC_DIMENSIONALITY> GetRandomKnotVectors(
  ...
  std::array<int, PARAMETRIC_DIMENSIONALITY> number_of_knots = GetNumberOfKnots<PARAMETRIC_DIMENSIONALITY>(degree);
  for (int i = 0; i < PARAMETRIC_DIMENSIONALITY; ++i) {
...
template<int PARAMETRIC_DIMENSIONALITY>
std::vector<baf::ControlPoint> GetRandomControlPoints(int dimension, const std::array<int,
...
template<int PARAMETRIC_DIMENSIONALITY>
std::vector<double> GetRandomWeights(const std::array<int, PARAMETRIC_DIMENSIONALITY> &number_of_points) {
  util::MultiIndexHandler<PARAMETRIC_DIMENSIONALITY> point_handler(number_of_points);
...
template<int PARAMETRIC_DIMENSIONALITY>
std::array<int, PARAMETRIC_DIMENSIONALITY> GetNumberOfPoints(
