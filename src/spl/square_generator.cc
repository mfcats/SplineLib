...
spl::SquareGenerator::SquareGenerator() : knot_vectors_(
    {baf::KnotVector{{zero_, zero_, zero_, one_, one_,
        one_}/*zero_, zero_, zero_, one_, one_, one_*/}, baf::KnotVector{
        {zero_, zero_, zero_, one_, one_,
            one_}/*zero_, zero_, zero_, one_, one_, one_*/}}),
                                          degrees_({2, 2}),
