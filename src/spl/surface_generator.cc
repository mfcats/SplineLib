...
std::shared_ptr<spl::ParameterSpace<2>> spl::SurfaceGenerator::JoinParameterSpaces(
    std::shared_ptr<ParameterSpace<1>> space_1, std::shared_ptr<ParameterSpace<1>> space_2) const {
  std::array<std::shared_ptr<baf::KnotVector>, 2> joined_knot_vector = {space_1->GetKnotVector(0), space_2->GetKnotVector(0)};
...
std::shared_ptr<spl::WeightedPhysicalSpace<2>> spl::SurfaceGenerator::JoinPhysicalSpaces(
    std::shared_ptr<spl::PhysicalSpace<1>> space_1, std::shared_ptr<spl::PhysicalSpace<1>> space_2) const {
  ...
  return std::make_shared<spl::WeightedPhysicalSpace<2>>(spl::WeightedPhysicalSpace<2>(joined_control_points, joined_weights, joined_number_of_points));
}
