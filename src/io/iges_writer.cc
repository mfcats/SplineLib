...
std::vector<std::string> io::IGESWriter::GetStartSection() {
...
std::vector<std::string> io::IGESWriter::GetGlobalSection(const std::string &filename,
                                                          ...
                                                          const std::vector<std::any> &splines) {
  std::string contents;
...
std::vector<std::string> io::IGESWriter::GetGlobalSectionLayout(const std::string *contents) {
  int line = 0;
...
void io::IGESWriter::GetParameterData1D(std::string *contents, const std::string &delimiter, const std::any &spline) {
...
void io::IGESWriter::GetParameterData2D(std::string *contents, const std::string &delimiter, const std::any &spline) {
...
template<int DIM>
double io::IGESWriter::Get3DControlPoint(std::shared_ptr<spl::Spline<DIM>> spline, int index, int direction) {
...
std::vector<std::string> io::IGESWriter::GetDataEntrySectionLayout(const std::string *contents, int *dLine) {
...
std::vector<std::string> io::IGESWriter::GetTerminateSection(int linesS, int linesG, int linesD, int linesP) {
...
int io::IGESWriter::GetDimension(const std::any &spline) {
...
bool io::IGESWriter::IsRational(std::any spline) {
  try {
...
std::string io::IGESWriter::GetHollerithFormat(const std::string &str) {
  return GetString(str.size()) + "H" + str;
}

std::string io::IGESWriter::GetBlock(const std::string &str, int width, bool right) {
  return right ? (std::string(width - str.size(), ' ') + str) : (str + std::string(width - str.size(), ' '));
}

template<typename T>
std::string io::IGESWriter::GetString(const T value) {
...
void io::IGESWriter::WriteFile(std::ofstream &file,
                               ...
                               const std::vector<std::string> &terminate) {
...
void io::IGESWriter::AppendToFile(std::ofstream &file, const std::vector<std::string> &contents) {
...
double io::IGESWriter::GetHighestValue(std::vector<std::any> splines) {
