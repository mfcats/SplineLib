...
class ALine : public Test {
 public:
  ...
  std::vector<spl::ControlPoint> control_points = {
      ...
      spl::ControlPoint(std::vector<double>({1.5})),
      ...
      spl::ControlPoint(std::vector<double>({6.5})),
      spl::ControlPoint(std::vector<double>({7.0})),
      spl::ControlPoint(std::vector<double>({7.5})),
      spl::ControlPoint(std::vector<double>({8.0}))};
...
/*class ASquarePlate : public Test {
 public:
  ...
  std::vector<spl::ControlPoint> control_points = {
      ...
      spl::ControlPoint(std::vector<double>({6.0, 0.0})),
      ...
      spl::ControlPoint(std::vector<double>({3.0, 1.0})),
      spl::ControlPoint(std::vector<double>({4.0, 1.0})),
      spl::ControlPoint(std::vector<double>({5.0, 1.0})),
      spl::ControlPoint(std::vector<double>({6.0, 1.0})),
      ...
      spl::ControlPoint(std::vector<double>({4.0, 2.0})),
      spl::ControlPoint(std::vector<double>({5.0, 2.0})),
      spl::ControlPoint(std::vector<double>({6.0, 2.0})),

      spl::ControlPoint(std::vector<double>({0.0, 3.0})),
      spl::ControlPoint(std::vector<double>({1.0, 3.0})),
      spl::ControlPoint(std::vector<double>({2.0, 3.0})),
      spl::ControlPoint(std::vector<double>({3.0, 3.0})),
      spl::ControlPoint(std::vector<double>({4.0, 3.0})),
      spl::ControlPoint(std::vector<double>({5.0, 3.0})),
      spl::ControlPoint(std::vector<double>({6.0, 3.0})),

      spl::ControlPoint(std::vector<double>({0.0, 4.0})),
      spl::ControlPoint(std::vector<double>({1.0, 4.0})),
      spl::ControlPoint(std::vector<double>({2.0, 4.0})),
      spl::ControlPoint(std::vector<double>({3.0, 4.0})),
      spl::ControlPoint(std::vector<double>({4.0, 4.0})),
      spl::ControlPoint(std::vector<double>({5.0, 4.0})),
      spl::ControlPoint(std::vector<double>({6.0, 4.0})),

      spl::ControlPoint(std::vector<double>({0.0, 5.0})),
      spl::ControlPoint(std::vector<double>({1.0, 5.0})),
      spl::ControlPoint(std::vector<double>({2.0, 5.0})),
      spl::ControlPoint(std::vector<double>({3.0, 5.0})),
      spl::ControlPoint(std::vector<double>({4.0, 5.0})),
      spl::ControlPoint(std::vector<double>({5.0, 5.0})),
      spl::ControlPoint(std::vector<double>({6.0, 5.0})),

      spl::ControlPoint(std::vector<double>({0.0, 6.0})),
      spl::ControlPoint(std::vector<double>({1.0, 6.0})),
      spl::ControlPoint(std::vector<double>({2.0, 6.0})),
      spl::ControlPoint(std::vector<double>({3.0, 6.0})),
      spl::ControlPoint(std::vector<double>({4.0, 6.0})),
      spl::ControlPoint(std::vector<double>({5.0, 6.0})),
      spl::ControlPoint(std::vector<double>({6.0, 6.0}))};
