...
class ACube : public Test {
 public:
  ...
  std::vector<baf::ControlPoint> control_points = {
      ...
      baf::ControlPoint(std::vector<double>({0.33, 0.33, 0.0})),
      baf::ControlPoint(std::vector<double>({0.66, 0.33, 0.0})),
      baf::ControlPoint(std::vector<double>({1.0, 0.33, 0.0})),
      baf::ControlPoint(std::vector<double>({0.0, 0.66, 0.0})),
      baf::ControlPoint(std::vector<double>({0.33, 0.66, 0.0})),
      baf::ControlPoint(std::vector<double>({0.66, 0.66, 0.0})),
      ...
      baf::ControlPoint(std::vector<double>({0.0, 0.0, 0.33})),
      baf::ControlPoint(std::vector<double>({0.33, 0.0, 0.33})),
      baf::ControlPoint(std::vector<double>({0.66, 0.0, 0.33})),
      baf::ControlPoint(std::vector<double>({1.0, 0.0, 0.33})),
      baf::ControlPoint(std::vector<double>({0.0, 0.33, 0.33})),
      baf::ControlPoint(std::vector<double>({0.33, 0.33, 0.33})),
      baf::ControlPoint(std::vector<double>({0.66, 0.33, 0.33})),
      baf::ControlPoint(std::vector<double>({1.0, 0.33, 0.33})),
      baf::ControlPoint(std::vector<double>({0.0, 0.66, 0.33})),
      baf::ControlPoint(std::vector<double>({0.33, 0.66, 0.33})),
      baf::ControlPoint(std::vector<double>({0.66, 0.66, 0.33})),
      baf::ControlPoint(std::vector<double>({1.0, 0.66, 0.33})),
      baf::ControlPoint(std::vector<double>({0.0, 1.0, 0.33})),
      baf::ControlPoint(std::vector<double>({0.33, 1.0, 0.33})),
      baf::ControlPoint(std::vector<double>({0.66, 1.0, 0.33})),
      baf::ControlPoint(std::vector<double>({1.0, 1.0, 0.33})),

      baf::ControlPoint(std::vector<double>({0.0, 0.0, 0.66})),
      baf::ControlPoint(std::vector<double>({0.33, 0.0, 0.66})),
      baf::ControlPoint(std::vector<double>({0.66, 0.0, 0.66})),
      baf::ControlPoint(std::vector<double>({1.0, 0.0, 0.66})),
      baf::ControlPoint(std::vector<double>({0.0, 0.33, 0.66})),
      baf::ControlPoint(std::vector<double>({0.33, 0.33, 0.66})),
      baf::ControlPoint(std::vector<double>({0.66, 0.33, 0.66})),
      baf::ControlPoint(std::vector<double>({1.0, 0.33, 0.66})),
      baf::ControlPoint(std::vector<double>({0.0, 0.66, 0.66})),
      baf::ControlPoint(std::vector<double>({0.33, 0.66, 0.66})),
      baf::ControlPoint(std::vector<double>({0.66, 0.66, 0.66})),
      baf::ControlPoint(std::vector<double>({1.0, 0.66, 0.66})),
      baf::ControlPoint(std::vector<double>({0.0, 1.0, 0.66})),
      baf::ControlPoint(std::vector<double>({0.33, 1.0, 0.66})),
      baf::ControlPoint(std::vector<double>({0.66, 1.0, 0.66})),
      baf::ControlPoint(std::vector<double>({1.0, 1.0, 0.66})),

      baf::ControlPoint(std::vector<double>({0.0, 0.0, 1.0})),
      baf::ControlPoint(std::vector<double>({0.33, 0.0, 1.0})),
      baf::ControlPoint(std::vector<double>({0.66, 0.0, 1.0})),
      baf::ControlPoint(std::vector<double>({1.0, 0.0, 1.0})),
      baf::ControlPoint(std::vector<double>({0.0, 0.33, 1.0})),
      baf::ControlPoint(std::vector<double>({0.33, 0.33, 1.0})),
      baf::ControlPoint(std::vector<double>({0.66, 0.33, 1.0})),
      baf::ControlPoint(std::vector<double>({1.0, 0.33, 1.0})),
      baf::ControlPoint(std::vector<double>({0.0, 0.66, 1.0})),
      baf::ControlPoint(std::vector<double>({0.33, 0.66, 1.0})),
      baf::ControlPoint(std::vector<double>({0.66, 0.66, 1.0})),
      baf::ControlPoint(std::vector<double>({1.0, 0.66, 1.0})),
      baf::ControlPoint(std::vector<double>({0.0, 1.0, 1.0})),
      baf::ControlPoint(std::vector<double>({0.33, 1.0, 1.0})),
      baf::ControlPoint(std::vector<double>({0.66, 1.0, 1.0})),
