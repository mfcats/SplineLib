...
class KnotVectorMock000111 : public baf::KnotVector {
 ...
 private:
  std::vector<baf::ParamCoord> knts = {
      baf::ParamCoord{0},
      baf::ParamCoord{0},
      baf::ParamCoord{0},
      baf::ParamCoord{1},
...
class ZeroDegreeBasisFunctionEx21N00 : public Test {
 public:
  ZeroDegreeBasisFunctionEx21N00() : basis_function_(knot_vector_000111, baf::KnotSpan{0}) {}
...
class ZeroDegreeBasisFunctionEx21N20 : public Test {
 public:
  ZeroDegreeBasisFunctionEx21N20() : basis_function_(knot_vector_000111, baf::KnotSpan{2}) {}
...
TEST_F(ZeroDegreeBasisFunctionEx21N20, IsOneAt0_5) { // NOLINT
  ASSERT_THAT(basis_function_.Evaluate(baf::ParamCoord{0.5}), DoubleEq(1.0));
}
...
class ZeroDegreeBasisFunctionEx21N40 : public Test {
 public:
  ZeroDegreeBasisFunctionEx21N40() : basis_function_(knot_vector_000111, baf::KnotSpan{0}) {}
...
class ZeroDegreeBasisFunctionEx22N00 : public Test {
 public:
  ZeroDegreeBasisFunctionEx22N00() : basis_function_(knot_vector_000111, baf::KnotSpan{0}) {}
...
TEST_F(ZeroDegreeBasisFunctionEx22N00, ZerothDerevitveIsEqualValueAt1_5) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{0}, baf::Derivative{1}),
...
TEST_F(ZeroDegreeBasisFunctionEx22N00, ZerothDerevitveIsEqualValueAt2_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{0}, baf::Derivative{2}),
...
TEST_F(ZeroDegreeBasisFunctionEx22N00, ZerothDerevitveIsEqualValueAt4_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{0}, baf::Derivative{4}),
...
TEST_F(ZeroDegreeBasisFunctionEx22N00, ZerothDerevitveIsEqualValueAt5_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{0}, baf::Derivative{5}),
...
TEST_F(ZeroDegreeBasisFunctionEx22N00, ZerothDerevitveIsEqualValueAt6_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{0}, baf::Derivative{6}),
...
TEST_F(ZeroDegreeBasisFunctionEx22N00, FirstDerevitveIsEqualZeroAt0_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{1}, baf::Derivative{0}), DoubleEq(0.0));
}

TEST_F(ZeroDegreeBasisFunctionEx22N00, FirstDerevitveIsEqualZeroAt1_5) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{1}, baf::Derivative{1}), DoubleEq(0.0));
}

TEST_F(ZeroDegreeBasisFunctionEx22N00, FirstDerevitveIsEqualZeroAt2_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{1}, baf::Derivative{2}), DoubleEq(0.0));
}

TEST_F(ZeroDegreeBasisFunctionEx22N00, FirstDerevitveIsEqualZeroAt4_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{1}, baf::Derivative{4}), DoubleEq(0.0));
}

TEST_F(ZeroDegreeBasisFunctionEx22N00, FirstDerevitveIsEqualZeroAt5_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{1}, baf::Derivative{5}), DoubleEq(0.0));
}

TEST_F(ZeroDegreeBasisFunctionEx22N00, FirstDerevitveIsEqualZeroAt6_0) { // NOLINT
  ASSERT_THAT(basis_function_.EvaluateDerivative(baf::ParamCoord{1}, baf::Derivative{6}), DoubleEq(0.0));
}
...
class ZeroDegreeBasisFunctionEx22N40 : public Test {
 public:
  ZeroDegreeBasisFunctionEx22N40() : basis_function_(knot_vector_000111, baf::KnotSpan{0}) {}
