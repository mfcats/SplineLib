...
class ZeroDegreeBasisFunctionEx21N00 : public Test {
 public:
  ZeroDegreeBasisFunctionEx21N00() : knot_vector_(vector<double>({0, 0, 0, 1, 1, 1})),
...
class ZeroDegreeBasisFunctionEx21N20 : public Test {
 public:
  ZeroDegreeBasisFunctionEx21N20() : knot_vector_(vector<double>({0, 0, 0, 1, 1, 1})),
...
TEST_F(ZeroDegreeBasisFunctionEx21N20, IsOneAt0_5) {
  ASSERT_THAT(basis_function_.Evaluate(0.5), DoubleEq(1.0));
}
...
class ZeroDegreeBasisFunctionEx21N40 : public Test {
 public:
  ZeroDegreeBasisFunctionEx21N40() : knot_vector_(vector<double>({0, 0, 0, 1, 1, 1})),
                                     basis_function_(knot_vector_, 0) {}
...
class ZeroDegreeBasisFunctionEx22N00 : public Test {
 public:
  ZeroDegreeBasisFunctionEx22N00() : knot_vector_(vector<double>({0, 0, 0, 1, 1, 1})),
                                     basis_function_(knot_vector_, 0) {}
