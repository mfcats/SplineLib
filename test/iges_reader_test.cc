...
TEST_F(A2DNurbsFromIGESFile, Read1DBSplineFromIGESFile) { // NOLINT
  auto b_spline_1d = std::any_cast<std::shared_ptr<spl::BSpline<1>>>(iges_reader_->ReadIGESFile(path_to_iges_file)[1]);
...
TEST_F(A2DNurbsFromIGESFile, Read1DNURBSWithWeigthsOneFromIGESFile) { // NOLINT
  auto nurbs_1d = std::any_cast<std::shared_ptr<spl::NURBS<1>>>(iges_reader_->ReadIGESFile(path_to_iges_file_2)[1]);
...
TEST_F(A2DNurbsFromIGESFile, Read2DNURBSFromIGESFile) { // NOLINT
  auto nurbs_2d = std::any_cast<std::shared_ptr<spl::NURBS<2>>>(iges_reader_->ReadIGESFile(path_to_iges_file)[0]);
...
TEST_F(A2DNurbsFromIGESFile, Read2DBSplineFromIGESFile) { // NOLINT
  auto
      b_spline_2d = std::any_cast<std::shared_ptr<spl::BSpline<2>>>(iges_reader_->ReadIGESFile(path_to_iges_file_2)[0]);
