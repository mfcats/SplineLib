 ...
 public:
  AnIGESReaderAndWriter() {
    ...
    std::vector<spl::ControlPoint> control_points = {
        ...
        spl::ControlPoint(std::vector<double>({0.0, 0.0, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({0.0, 0.0, -1.0})),
        spl::ControlPoint(std::vector<double>({0.0, 0.0, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({0.0, 0.0, -1.0})),
        spl::ControlPoint(std::vector<double>({0.0, 0.0, -0.99999999999999989})),
        ...
        spl::ControlPoint(std::vector<double>({0.0, 0.0, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({0.0, 0.0, -1.0})),
        spl::ControlPoint(std::vector<double>({0.99999999999999989, 0.0, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({0.99999999999999978, 0.99999999999999944, -0.99999999999999956})),
        spl::ControlPoint(std::vector<double>({6.1232339957367648E-17, 0.99999999999999989, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({-0.99999999999999956, 0.99999999999999978, -0.99999999999999956})),
        spl::ControlPoint(std::vector<double>({-0.99999999999999989, 1.224646799147353E-16, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({-0.99999999999999978, -0.99999999999999956, -0.99999999999999956})),
        spl::ControlPoint(std::vector<double>({-1.8369701987210294E-16, -0.99999999999999989, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({0.99999999999999978, -0.99999999999999956, -0.99999999999999956})),
        spl::ControlPoint(std::vector<double>({0.99999999999999989, 0.0, -0.99999999999999989})),
        spl::ControlPoint(std::vector<double>({1.0, 0.0, 0.0})),
        spl::ControlPoint(std::vector<double>({0.99999999999999989, 0.99999999999999989, 0.0})),
        spl::ControlPoint(std::vector<double>({6.123233995736766E-17, 1.0, 0.0})),
        spl::ControlPoint(std::vector<double>({-0.99999999999999989, 0.99999999999999967, 0.0})),
        spl::ControlPoint(std::vector<double>({-1.0, 1.2246467991473532E-16, 0.0})),
        spl::ControlPoint(std::vector<double>({-1.0, -0.99999999999999989, 0.0})),
        spl::ControlPoint(std::vector<double>({-1.8369701987210297E-16, -1.0, 0.0})),
