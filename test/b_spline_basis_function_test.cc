...
TEST_F(BasisFunctionEx22N01, ZerothDerevitveIsEqualValueAt1_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(1.5, 0), DoubleEq(basis_function_.Evaluate(ParamCoord{1.5)));
}

TEST_F(BasisFunctionEx22N01, ZerothDerevitveIsEqualValueAt2_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(2.0, 0), DoubleEq(basis_function_.Evaluate(ParamCoord{2.0)));
}

TEST_F(BasisFunctionEx22N01, ZerothDerevitveIsEqualValueAt4_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.0, 0), DoubleEq(basis_function_.Evaluate(ParamCoord{4.0)));
}

TEST_F(BasisFunctionEx22N01, ZerothDerevitveIsEqualValueAt5_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(5.0, 0), DoubleEq(basis_function_.Evaluate(ParamCoord{5.0)));
}

TEST_F(BasisFunctionEx22N01, ZerothDerevitveIsEqualValueAt6_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(6.0, 0), DoubleEq(basis_function_.Evaluate(ParamCoord{6.0)));
}

TEST_F(BasisFunctionEx22N01, ZerothDerevitveIsEqualValueAtMinus0_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(-0.5, 0),
              DoubleEq(basis_function_.Evaluate(ParamCoord{-0.5)));
}

TEST_F(BasisFunctionEx22N01, FirstDerevitveIsEqualZeroAt0_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(0.0, 1), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N01, FirstDerevitveIsEqualZeroAt1_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(1.5, 1), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N01, FirstDerevitveIsEqualZeroAt2_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(2.0, 1), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N01, FirstDerevitveIsEqualZeroAt4_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.0, 1), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N01, FirstDerevitveIsEqualZeroAt5_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(5.0, 1), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N01, FirstDerevitveIsEqualZeroAt6_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(6.0, 1), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N01, FirstDerevitveIsEqualZeroAtMinus0_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(-0.5, 1), DoubleEq(0.0));
}

// Test basis function derivative N_{3,1} from NURBS book example 2.2
class BasisFunctionEx22N13 : public Test {
 public:
  BasisFunctionEx22N13() : knot_vector_(baf::KnotVector({ParamCoord{0, knot_vector_(baf::KnotVector(vector<ParamCoord>({ParamCoord{0}, ParamCoord{0}, ParamCoord{0}, ParamCoord{1}, ParamCoord{2}, ParamCoord{3}, ParamCoord{4}, ParamCoord{4}, ParamCoord{5}, ParamCoord{5}, ParamCoord{5}}),
                           basis_function_(knot_vector_, 1, 3) {}
...
TEST_F(BasisFunctionEx22N13, FirstDerevitveIsEqual1At1_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(1.0, 1), DoubleEq(1.0));
}

TEST_F(BasisFunctionEx22N13, FirstDerevitveIsEqual1At1_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(1.5, 1), DoubleEq(1.0));
}

TEST_F(BasisFunctionEx22N13, FirstDerevitveIsEqualMinus1At2_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(2.0, 1), DoubleEq(-1.0));
}

TEST_F(BasisFunctionEx22N13, FirstDerevitveIsEqualMinus1At2_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(2.5, 1), DoubleEq(-1.0));
}

TEST_F(BasisFunctionEx22N13, FirstDerevitveIsEqual0At3_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(3.0, 1), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N13, FourthDerevitveIsEqual0At1_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(1.5, 4), DoubleEq(0.0));
}

// Test basis function derivative N_{6,1} from NURBS book example 2.2
class BasisFunctionEx22N61 : public Test {
 public:
  BasisFunctionEx22N61() : knot_vector_(baf::KnotVector({ParamCoord{0, knot_vector_(baf::KnotVector(vector<ParamCoord>({ParamCoord{0}, ParamCoord{0}, ParamCoord{0}, ParamCoord{1}, ParamCoord{2}, ParamCoord{3}, ParamCoord{4}, ParamCoord{4}, ParamCoord{5}, ParamCoord{5}, ParamCoord{5}}),
...
TEST_F(BasisFunctionEx22N61, FirstDerevitveIsEqualMinus1At4_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.0, 1), DoubleEq(-1.0));
}

TEST_F(BasisFunctionEx22N61, SecondDerevitveIsEqual0At4_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.5, 2), DoubleEq(0.0));
}
...
TEST_F(BasisFunctionEx22N72, SecondDerevitveIsEqual2At4_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.0, 2), DoubleEq(2.0));
}

TEST_F(BasisFunctionEx22N72, ThirdDerevitveIsEqual0At4_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.0, 3), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N72, FirstDerevitveIsEqual1At4_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.5, 1), DoubleEq(1.0));
}

TEST_F(BasisFunctionEx22N72, SecondDerevitveIsEqual2At4_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.5, 2), DoubleEq(2.0));
}

TEST_F(BasisFunctionEx22N72, ThirdDerevitveIsEqual0At4_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(4.5, 3), DoubleEq(0.0));
}

TEST_F(BasisFunctionEx22N72, FirstDerevitveIsEqual2At5_0) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(5.0, 1), DoubleEq(2.0));
}

TEST_F(BasisFunctionEx22N72, FirstDerevitveIsEqual0At5_5) {
  ASSERT_THAT(basis_function_.EvaluateDerivative(5.5, 1), DoubleEq(0.0));
}
