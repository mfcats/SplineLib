 ...
 public:
  ABSplineSurface() {
    ...
    std::vector<spl::ControlPoint> control_points = {
        spl::ControlPoint(std::vector<double>({-236, -197, -22})),
        spl::ControlPoint(std::vector<double>({-206, -117, -22})),
        spl::ControlPoint(std::vector<double>({-216, -27, 8})),
        spl::ControlPoint(std::vector<double>({-246, 62, -22})),
        spl::ControlPoint(std::vector<double>({-156, -177, 8})),
        spl::ControlPoint(std::vector<double>({-176, -97, 38})),
        spl::ControlPoint(std::vector<double>({-157, 20, 126})),
        spl::ControlPoint(std::vector<double>({-186, 142, 8})),
        spl::ControlPoint(std::vector<double>({-86, -157, 8})),
        spl::ControlPoint(std::vector<double>({-138, -113, -146})),
        spl::ControlPoint(std::vector<double>({-104, 14, -60})),
        spl::ControlPoint(std::vector<double>({-96, 102, 8})),
        spl::ControlPoint(std::vector<double>({-6, -197, -22})),
        spl::ControlPoint(std::vector<double>({-47, -96, -33})),
        spl::ControlPoint(std::vector<double>({25, 32, 95})),
        spl::ControlPoint(std::vector<double>({-6, 102, 8})),
        spl::ControlPoint(std::vector<double>({74, -177, 8})),
        spl::ControlPoint(std::vector<double>({34, -75, 147})),
        spl::ControlPoint(std::vector<double>({86, 97, 105})),
        spl::ControlPoint(std::vector<double>({54, 142, 8})),
        spl::ControlPoint(std::vector<double>({124, -157, 8})),
        spl::ControlPoint(std::vector<double>({198, -31, 63})),
        spl::ControlPoint(std::vector<double>({64, 31, 154})),
        spl::ControlPoint(std::vector<double>({144, 102, 8})),
        spl::ControlPoint(std::vector<double>({204, -197, -22})),
        spl::ControlPoint(std::vector<double>({234, -77, 8})),
        spl::ControlPoint(std::vector<double>({214, -7, 8})),
        spl::ControlPoint(std::vector<double>({239, 102, -22}))
    };
