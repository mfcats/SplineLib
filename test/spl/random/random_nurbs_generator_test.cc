...
class A1DRandomNURBSGenerator : public Test {  // NOLINT
 public:
  A1DRandomNURBSGenerator() : nurbs_generator_(RandomNURBSGenerator<1>(limits_, max_degree_, dimension_)) {}
 ...
 protected:
  ...
  RandomNURBSGenerator<1> nurbs_generator_;
};
...
class A2DRandomNURBSGenerator : public Test {  // NOLINT
 public:
  A2DRandomNURBSGenerator() : nurbs_generator_(RandomNURBSGenerator<2>(limits_, max_degree_, dimension_)) {}
 ...
 protected:
  ...
  RandomNURBSGenerator<2> nurbs_generator_;
};
...
class A3DRandomNURBSGenerator : public Test {  // NOLINT
 public:
  A3DRandomNURBSGenerator() : nurbs_generator_(RandomNURBSGenerator<3>(limits_, max_degree_, dimension_)) {}
 ...
 protected:
  ...
  RandomNURBSGenerator<3> nurbs_generator_;
};
