...
TEST_F(A2DNurbs, Returns1_6For0_4And0_6AndDim0) { // NOLINT
  ...
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{0.4}, baf::ParamCoord{0.6}}, {0})[0], DoubleNear(1.62074, 0.00001));
}

TEST_F(A2DNurbs, Returns1_9For0_4And0_6AndDim1) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{0.4}, baf::ParamCoord{0.6}}, {1})[0], DoubleNear(1.88267, 0.00001));
}

TEST_F(A2DNurbs, Returns2_5For0_5And1_0AndDim0) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{0.5}, baf::ParamCoord{1.0}}, {0})[0],
...
TEST_F(A2DNurbs, Returns3_0For0_5And1_0AndDim1) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{0.5}, baf::ParamCoord{1.0}}, {1})[0],
...
TEST_F(A2DNurbs, Returns4_2For0_9And1_0AndDim0) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{0.9}, baf::ParamCoord{1.0}}, {0})[0], DoubleNear(4.19492, 0.00001));
}

TEST_F(A2DNurbs, Returns2_5For0_9And1_0AndDim1) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{0.9}, baf::ParamCoord{1.0}}, {1})[0], DoubleNear(2.45763, 0.00001));
}

TEST_F(A2DNurbs, EvaluatesMultipleValues) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{1.0}, baf::ParamCoord{0.0}}, {0, 1})[0], DoubleEq(3.0));
  ASSERT_THAT(nurbs_->Evaluate({baf::ParamCoord{1.0}, baf::ParamCoord{0.0}}, {0, 1})[1], DoubleEq(0.0));
}

TEST_F(A2DNurbs, Returns10_0For0_0And1_0ForDerivative1And0AndDim0) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{1.0}}, {0}, {1, 0})[0], DoubleEq(10.0));
}

TEST_F(A2DNurbs, Returns6_0For0_0And1_0ForDerivative1And0AndDim1) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{1.0}}, {1}, {1, 0})[0], DoubleEq(6.0));
}

TEST_F(A2DNurbs, Returns2_0For0_0And1_0ForDerivative0And1AndDim0) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{1.0}}, {0}, {0, 1})[0], DoubleEq(2.0));
}

TEST_F(A2DNurbs, Returns3_0For0_0And1_0ForDerivative0And1AndDim1) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{1.0}}, {1}, {0, 1})[0], DoubleEq(3.0));
}

TEST_F(A2DNurbs, Returns4_2For0_4And0_6ForDerivative1And0AndDim0) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.4}, baf::ParamCoord{0.6}}, {0}, {1, 0})[0],
...
TEST_F(A2DNurbs, Returns0_8For0_4And0_6ForDerivative1And0AndDim1) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.4}, baf::ParamCoord{0.6}}, {1}, {1, 0})[0],
...
TEST_F(A2DNurbs, Returns1_4For0_4And0_6ForDerivative0And1AndDim0) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.4}, baf::ParamCoord{0.6}}, {0}, {0, 1})[0],
...
TEST_F(A2DNurbs, Returns3_1For0_4And0_6ForDerivative0And1AndDim1) { // NOLINT
  mock_parameterSpace_nurbs(parameter_space);
  mock_weightedPhysicalSpace(w_physical_space);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.4}, baf::ParamCoord{0.6}}, {1}, {0, 1})[0],
...
TEST_F(A2DNurbsWithAllWeights1, ReturnsSameDerivativeAs2DBSplineFor0_5And0_5AndDerivatives1And1) { // NOLINT
  ...
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.5}, baf::ParamCoord{0.5}}, {0}, {1, 1})[0],
      DoubleNear(bspline_->EvaluateDerivative({baf::ParamCoord{0.5}, baf::ParamCoord{0.5}}, {0}, {1, 1})[0], 0.000001));
}
...
TEST_F(A2DNurbsWithAllWeights1, ReturnsSameDerivativeAs2DBSplineFor0_0And0_7AndDerivatives1And1) { // NOLINT
  ...
  mock_parameterSpace_nurbs(parameter_space_m);
  mock_physicalSpace(physical_space_m);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{0.7}}, {0}, {1, 1})[0],
      DoubleNear(bspline_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{0.7}}, {0}, {1, 1})[0], 0.000001));
}
...
TEST_F(A2DNurbsWithAllWeights1, ReturnsSameDerivativeAs2DBSplineFor0_0And0_7AndDerivatives2And1) { // NOLINT
  ...
  mock_parameterSpace_nurbs(parameter_space_m);
  mock_physicalSpace(physical_space_m);
  ASSERT_THAT(nurbs_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{0.7}}, {0}, {2, 1})[0],
      DoubleNear(bspline_->EvaluateDerivative({baf::ParamCoord{0.0}, baf::ParamCoord{0.7}}, {0}, {2, 1})[0], 0.000001));
}
