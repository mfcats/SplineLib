...
TEST_F(A2DNurbsWithAllWeights1, ReturnsSameDerivativeAs2DBSplineFor0_5And0_5AndDerivatives1And1) {  // NOLINT
  ...
  ASSERT_THAT(nurbs_->EvaluateDerivative({ParametricCoordinate{0.5}, ParametricCoordinate{0.5}}, {0}, {1, 1})[0],
              DoubleNear(bspline_->EvaluateDerivative({ParametricCoordinate{0.5}, ParametricCoordinate{0.5}},
                                                      {0},
                                                      {1, 1})[0], 0.000001));
}
...
TEST_F(A2DNurbsWithAllWeights1, ReturnsSameDerivativeAs2DBSplineFor0_0And0_7AndDerivatives1And1) {  // NOLINT
  ...
  mock_parameterSpace_nurbs(parameter_space_m);
  mock_physicalSpace(physical_space_m);
  ASSERT_THAT(nurbs_->EvaluateDerivative({ParametricCoordinate{0.0}, ParametricCoordinate{0.7}}, {0}, {1, 1})[0],
              DoubleNear(bspline_->EvaluateDerivative({ParametricCoordinate{0.0}, ParametricCoordinate{0.7}},
                                                      {0},
                                                      {1, 1})[0], 0.000001));
}
...
TEST_F(A2DNurbsWithAllWeights1, ReturnsSameDerivativeAs2DBSplineFor0_0And0_7AndDerivatives2And1) {  // NOLINT
  ...
  mock_parameterSpace_nurbs(parameter_space_m);
  mock_physicalSpace(physical_space_m);
  ASSERT_THAT(nurbs_->EvaluateDerivative({ParametricCoordinate{0.0}, ParametricCoordinate{0.7}}, {0}, {2, 1})[0],
              DoubleNear(bspline_->EvaluateDerivative({ParametricCoordinate{0.0}, ParametricCoordinate{0.7}},
                                                      {0},
                                                      {2, 1})[0], 0.000001));
}
