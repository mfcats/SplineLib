...
TEST_F(A1DParameterSpace, ThrowsForTooShortKnotVector) {  // NOLINT
  knot_vector_ = {std::make_shared<baf::KnotVector>(baf::KnotVector(
      {baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{5}, baf::ParamCoord{5}}))};
...
TEST_F(A1DParameterSpace, ThrowsForMissingMultiplicityOfFirstKnot) {  // NOLINT
  knot_vector_ = {std::make_shared<baf::KnotVector>(baf::KnotVector(
      {baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{1}, baf::ParamCoord{5}, baf::ParamCoord{5},
       baf::ParamCoord{5}}))};
  ASSERT_THROW(spl::ParameterSpace<1>(knot_vector_, degree_), std::runtime_error);
}
...
TEST_F(A1DParameterSpace, ThrowsForMissingMultiplicityOfLastKnot) {  // NOLINT
  knot_vector_ = {std::make_shared<baf::KnotVector>(baf::KnotVector(
      {baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{4}, baf::ParamCoord{5},
       baf::ParamCoord{5}}))};
  ASSERT_THROW(spl::ParameterSpace<1>(knot_vector_, degree_), std::runtime_error);
}

TEST_F(A1DParameterSpace, ReturnsCorrectDegree) {  // NOLINT
  ASSERT_THAT(parameter_space.GetDegree(0), baf::Degree{2});
}
...
TEST_F(A1DParameterSpace, ReturnsCorrectBasisFunctionValuesForParamCoord0_5) {  // NOLINT
  ...
  for (int i = 0; i < 8; ++i) {
    ASSERT_THAT(parameter_space.GetBasisFunctions({i}, {baf::ParamCoord(0.5)}), DoubleEq(values[i]));
  }
}
...
TEST_F(A1DParameterSpace, ReturnsCorrectBasisFunctionDerivativeValuesForParamCoord0_5AndDerivative1) {  // NOLINT
  ...
  for (int i = 0; i < 8; ++i) {
    ASSERT_THAT(parameter_space.GetBasisFunctionDerivatives({i}, {baf::ParamCoord(0.5)}, {1}), DoubleEq(values[i]));
  }
}

TEST_F(A1DParameterSpace, Returns1AsFirstNonZeroBasisFunctionsForParamCoord1_5) { // NOLINT
  ASSERT_THAT(parameter_space.GetArrayOfFirstNonZeroBasisFunctions({baf::ParamCoord(1.5)})[0], 1);
}

TEST_F(A1DParameterSpace, Returns5AsFirstNonZeroBasisFunctionsForParamCoord4) { // NOLINT
  ASSERT_THAT(parameter_space.GetArrayOfFirstNonZeroBasisFunctions({baf::ParamCoord(4.0)})[0], 5);
}

TEST_F(A1DParameterSpace, ThrowsIfParametricCoordinateOutsideKnotVectorRange) { // NOLINT
  ASSERT_THROW(parameter_space.ThrowIfParametricCoordinateOutsideKnotVectorRange({baf::ParamCoord(5.1)}),
      std::range_error);
}

TEST_F(A1DParameterSpace, InsertsKnotCorrectly) {  // NOLINT
  parameter_space.InsertKnot(baf::ParamCoord(0.5), 0);
...
TEST_F(A1DParameterSpace, RemovesKnotCorrectly) {  // NOLINT
  parameter_space.RemoveKnot(baf::ParamCoord(1), 0);
  ...
  for (int i = 0; i < 7; ++i) {
    ASSERT_THAT(parameter_space.GetBasisFunctions({i}, {baf::ParamCoord(0.5)}), DoubleNear(values[i], 1e-6));
  }
}
...
class A2DParameterSpace : public Test {
 public:
  A2DParameterSpace() : degree_{baf::Degree{2}, baf::Degree{1}},
                        knot_vector_{
                          std::make_shared<baf::KnotVector>(baf::KnotVector{
                            baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{1},
                            baf::ParamCoord{1}, baf::ParamCoord{1}}),
                          std::make_shared<baf::KnotVector>(baf::KnotVector{
                            baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{1}, baf::ParamCoord{2},
                            baf::ParamCoord{3}, baf::ParamCoord{3}})},
                        parameter_space(knot_vector_, degree_) {}

 protected:
  std::array<baf::Degree, 2> degree_;
...
TEST_F(A2DParameterSpace, ReturnsDegree1ForSecondDimension) {  // NOLINT
  ASSERT_THAT(parameter_space.GetDegree(1), baf::Degree{1});
}
...
TEST_F(A2DParameterSpace, ReturnsCorrectBasisFunctionValue) {  // NOLINT
  ASSERT_THAT(parameter_space.GetBasisFunctions({1, 1}, {baf::ParamCoord(0.5), baf::ParamCoord(0.25)}),
      DoubleEq(0.125));
}
...
TEST_F(A2DParameterSpace, ReturnsCorrectBasisFunctionDerivativeValue) {  // NOLINT
  ASSERT_THAT(parameter_space.GetBasisFunctionDerivatives({1, 1},
      {baf::ParamCoord(0.5), baf::ParamCoord(0.25)}, {0, 1}), DoubleEq(0.5));
}
...
class A3DParameterSpace : public Test {
 public:
  A3DParameterSpace() : degree_{baf::Degree{2}, baf::Degree{0}, baf::Degree{1}},
                        knot_vector_{
                            std::make_shared<baf::KnotVector>(baf::KnotVector(
                                {std::vector<baf::ParamCoord>(
                                    {baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{1},
                                     baf::ParamCoord{1}, baf::ParamCoord{1}})})),
                            std::make_shared<baf::KnotVector>(baf::KnotVector(
                                {std::vector<baf::ParamCoord>(
                                    {baf::ParamCoord{0}, baf::ParamCoord{0.3}, baf::ParamCoord{0.6},
                                     baf::ParamCoord{0.9}})})),
                            std::make_shared<baf::KnotVector>(baf::KnotVector(
                                {std::vector<baf::ParamCoord>(
                                    {baf::ParamCoord{0}, baf::ParamCoord{0}, baf::ParamCoord{1}, baf::ParamCoord{2},
 ...
 protected:
  std::array<baf::Degree, 3> degree_;
...
TEST_F(A3DParameterSpace, ReturnsDegree0ForSecondDimension) {  // NOLINT
  ASSERT_THAT(parameter_space.GetDegree(1), baf::Degree{0});
}

TEST_F(A3DParameterSpace, ReturnsDegree1ForThirdDimension) {  // NOLINT
  ASSERT_THAT(parameter_space.GetDegree(2), baf::Degree{1});
}
...
TEST_F(A3DParameterSpace, ReturnsCorrectBasisFunctionValue) {  // NOLINT
  ASSERT_THAT(parameter_space.GetBasisFunctions({1, 1, 1},
      {baf::ParamCoord(0.5), baf::ParamCoord(0.5), baf::ParamCoord(0.25)}), DoubleEq(0.125));
}
...
TEST_F(A3DParameterSpace, ReturnsCorrectBasisFunctionDerivativeValue) {  // NOLINT
  ASSERT_THAT(parameter_space.GetBasisFunctionDerivatives({1, 1, 1},
      {baf::ParamCoord(0.5), baf::ParamCoord(0.5), baf::ParamCoord(0.25)}, {0, 0, 1}), DoubleEq(0.5));
}
