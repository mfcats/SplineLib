...
class BSpline2DFig5_28b : public Test {  // NOLINT
 public:
  BSpline2DFig5_28b() {
    std::vector<baf::ControlPoint> control_points = {
        baf::ControlPoint(std::vector<double>({0, 1, 4})), baf::ControlPoint(std::vector<double>({1, 1, 4.5})),
        baf::ControlPoint(std::vector<double>({2.5, 1, 3.5})), baf::ControlPoint(std::vector<double>({3.5, 1, 2.5})),
        baf::ControlPoint(std::vector<double>({5, 1, 2})), baf::ControlPoint(std::vector<double>({6.5, 1, 2.5})),

        baf::ControlPoint(std::vector<double>({0, 1.5, 3.9})), baf::ControlPoint(std::vector<double>({1, 1.5, 4.4})),
        baf::ControlPoint(std::vector<double>({2.5, 1.5, 3.4})),
        baf::ControlPoint(std::vector<double>({3.5, 1.5, 2.4})),
        baf::ControlPoint(std::vector<double>({5, 1.5, 1.9})), baf::ControlPoint(std::vector<double>({6.5, 1.5, 2.4})),

        baf::ControlPoint(std::vector<double>({0, 2, 3.8})), baf::ControlPoint(std::vector<double>({1, 2, 4.3})),
        baf::ControlPoint(std::vector<double>({2.5, 2, 3.3})), baf::ControlPoint(std::vector<double>({3.5, 2, 2.3})),
        baf::ControlPoint(std::vector<double>({5, 2, 1.8})), baf::ControlPoint(std::vector<double>({6.5, 2, 2.3})),

        baf::ControlPoint(std::vector<double>({0, 2.5, 3.7})), baf::ControlPoint(std::vector<double>({1, 2.5, 4.2})),
        baf::ControlPoint(std::vector<double>({2.5, 2.5, 3.2})),
        baf::ControlPoint(std::vector<double>({3.5, 2.5, 2.2})),
        baf::ControlPoint(std::vector<double>({5, 2.5, 1.7})), baf::ControlPoint(std::vector<double>({6.5, 2.5, 2.2})),

        baf::ControlPoint(std::vector<double>({0, 3, 3.6})), baf::ControlPoint(std::vector<double>({1, 3, 4.1})),
        baf::ControlPoint(std::vector<double>({2.5, 3, 3.1})), baf::ControlPoint(std::vector<double>({3.5, 3, 2.1})),
        baf::ControlPoint(std::vector<double>({5, 3, 1.6})), baf::ControlPoint(std::vector<double>({6.5, 3, 2.1})),

        baf::ControlPoint(std::vector<double>({0, 4, 3.3})), baf::ControlPoint(std::vector<double>({1, 4, 3.8})),
        baf::ControlPoint(std::vector<double>({2.5, 4, 2.8})), baf::ControlPoint(std::vector<double>({3.5, 4, 1.8})),
        baf::ControlPoint(std::vector<double>({5, 4, 1.3})), baf::ControlPoint(std::vector<double>({6.5, 4, 1.8})),

        baf::ControlPoint(std::vector<double>({0, 5, 3})), baf::ControlPoint(std::vector<double>({1, 5, 3.5})),
        baf::ControlPoint(std::vector<double>({2.5, 5, 2.5})), baf::ControlPoint(std::vector<double>({3.5, 5, 1.5})),
        baf::ControlPoint(std::vector<double>({5, 5, 1})), baf::ControlPoint(std::vector<double>({6.5, 5, 1.5})),

        baf::ControlPoint(std::vector<double>({0, 5.5, 3})), baf::ControlPoint(std::vector<double>({1, 5.5, 3.5})),
        baf::ControlPoint(std::vector<double>({2.5, 5.5, 2.5})),
        baf::ControlPoint(std::vector<double>({3.5, 5.5, 1.5})),
        baf::ControlPoint(std::vector<double>({5, 5.5, 1})), baf::ControlPoint(std::vector<double>({6.5, 5.5, 1.5}))
    };
