...
class A1DParameterSpace : public Test {
 public:
  A1DParameterSpace() : parameter_space({baf::KnotVector({ParamCoord{0}, ParamCoord{0}, ParamCoord{0}, ParamCoord{1},
                                                             ParamCoord{2}, ParamCoord{3},
                                                             ParamCoord{4}, ParamCoord{4}, ParamCoord{5}, ParamCoord{5},
                                                             ParamCoord{5}})}, std::array<Degree, 1>({Degree{2}})) {
  }
...
class A2DParameterSpace : public Test {
 public:
  A2DParameterSpace() : parameter_space({baf::KnotVector({std::vector<ParamCoord>({ParamCoord{0}, ParamCoord{0},
                                                                                      ParamCoord{0}, ParamCoord{1},
                                                                                      ParamCoord{1}, ParamCoord{1}})}),
                                            baf::KnotVector({std::vector<ParamCoord>({ParamCoord{0}, ParamCoord{0},
...
class A3DParameterSpace : public Test {
 public:
  A3DParameterSpace() : parameter_space({baf::KnotVector({std::vector<ParamCoord>({ParamCoord{0}, ParamCoord{0},
                                                                                      ParamCoord{0}, ParamCoord{1},
                                                                                      ParamCoord{1}, ParamCoord{1}})}),
                                            baf::KnotVector({std::vector<ParamCoord>({ParamCoord{0}, ParamCoord{0.3},
                                                                                         ParamCoord{0.6},
                                                                                         ParamCoord{0.9}})}),
                                            baf::KnotVector({std::vector<ParamCoord>({ParamCoord{0}, ParamCoord{0},
                                                                                         ParamCoord{1}, ParamCoord{2},
